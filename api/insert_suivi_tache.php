...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['id_tache']) && isset($_POST['code_tache']) && isset($_POST['lot'])) {
        ...
        $insertQuery = "INSERT INTO suivi_tache
            (id_tache , date_suivi, statut , difficultes, etat_avancement, source_verification, id_personnel)
            VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        $stmt->bind_param("sssssss", $taskId, $newDateFin, $statut_tache, $difficultes, $newObservation, $filename, $id_personnel);
