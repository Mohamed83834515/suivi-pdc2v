...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if (isset($_GET['responsable'])) {
        ...
        $query = "SELECT * FROM suivi_avenant WHERE id_personnel = '$userId' ";
        //  AND TIMESTAMPDIFF(day,now(),date_avenant)<=7 AND TIMESTAMPDIFF(day,now(),date_avenant)>=0 ORDER BY date_enregistrement DESC;
