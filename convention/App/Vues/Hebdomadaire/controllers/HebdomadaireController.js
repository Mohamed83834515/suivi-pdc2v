DECAISSEMENT.controller('HebdomadaireController', function ($rootScope, $scope, $http, $cookies, $filter, $location, $routeParams, $httpParamSerializer) {
	...
	$scope.getListePlanification = function () {
		...
		$http({
			method: 'GET',
			url: $scope.link + '/convention/api/tacheByactivite1.php',
			headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
		}).success(function (data) {
	...
	$scope.getSuiviPlanification = function () {
		...
		$http({
			method: 'GET',
			url: $scope.link + '/convention/api/suivi_planification.php',
			headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
		}).success(function (data) {
	...
	$scope.confirmDelete = function(Motif,id_activite_ptba_1) {
		...
		.then((willDelete) => {
			if (willDelete) {
				...
				$http.delete($scope.link + '/convention/api/supprimer_suivi_hebdomadaire.php?id_suivi=' + id_activite_ptba_1)
	...
	$scope.UpdatePlanification = function (idtache) {
		...
		$http({
			method: 'post',
			url: $scope.link + '/convention/api/insert_suivi_planification.php',
			data: fd,
	...
	$scope.UpdatePlanificationSuivi = function () {
		...
		$http({
			method: 'post',
			url: $scope.link + '/convention/api/update_suivi_planification.php',
			data: fd,
			headers: { 'Content-Type': undefined },
		}).then(function successCallback(response) {
			$scope.response = response.data
	...
	$scope.ValideTache = function (id_act) {
		...
		$http.post($scope.link + '/convention/api/valide_planification.php', donnee, config)
			.then(function (response) {
