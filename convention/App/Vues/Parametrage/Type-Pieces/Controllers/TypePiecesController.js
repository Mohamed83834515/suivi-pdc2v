...
DECAISSEMENT.controller('TypePieceController', function ($rootScope,$scope, $http, $cookies) {
	...
	$scope.InsertTypePiece = function () {
		...
		$http({
			method: 'POST',
			url: $scope.link +'/convention/api/Controllers/TypePieceController.php?Action=Add',
	...
	$scope.UpdateTypePiece = function () {
		...
		$http({
			method: 'POST',
			url: $scope.link +'/convention/api/Controllers/TypePieceController.php?Action=Update&IdTypePiece=' + $scope.TypePiece.IdTypePiece,
			headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
			data: donnee
		}).success(function (data) {
	...
	$scope.DeleteTypePiece = function (IdTypePiece) {
		...
		$http({
			method: 'POST',
			url: $scope.link +'/convention/api/Controllers/TypePieceController.php?Action=Delete&IdTypePiece=' + IdTypePiece,
			headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
			data: donnee
		}).success(function (data) {
