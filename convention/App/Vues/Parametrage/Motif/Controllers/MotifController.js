	...
	DECAISSEMENT.controller('MotifController', function($rootScope,$scope,$http,$cookies){
        ...
        $scope.InsertMotif = function () {
            ...
            $http({
                method: 'POST',
                url: $scope.link +'/convention/api/Controllers/MotifController.php?Action=Add',
        ...
        $scope.UpdateMotif = function () {
            ...
            $http({
                method: 'POST',
                url: $scope.link +'/convention/api/Controllers/MotifController.php?Action=Update&IdMotif=' + $scope.Motif.IdMotif,
                headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
                data: donnee
            }).success(function (data) {
        ...
        $scope.DeleteMotif = function (IdMotif) {
            ...
            $http({
                method: 'POST',
                url: $scope.link +'/convention/api/Controllers/MotifController.php?Action=Geler&IdMotif=' + IdMotif,
                headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
                data: donnee
            }).success(function (data) {
