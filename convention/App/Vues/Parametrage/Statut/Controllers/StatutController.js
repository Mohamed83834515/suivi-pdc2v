	...
	$scope.InsertStatut = function(){
			...
			$http({
				method: 'POST',
				url: $scope.link +'/convention/api/Controllers/TypeStatutController.php?Action=Add',
	...
	$scope.UpdateStatut = function(){
		...
		var donnee = $.param($scope.Statut);
			$http({
				method: 'POST',
				url: $scope.link +'/convention/api/Controllers/TypeStatutController.php?Action=Update&IdTypeStatut='+$scope.Statut.IdTypeStatut,
				headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
				data: donnee
			}).success(function (data) {
	...
	$scope.DeleteStatut = function(IdTypeStatut){
		...
		var donnee = $.param($scope.Statut);
			$http({
				method: 'POST',
				url: $scope.link +'/convention/api/Controllers/TypeStatutController.php?Action=Delete&IdTypeStatut='+IdTypeStatut,
				headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
				data: donnee
			}).success(function (data) {
	...
	//Debut fonction obtenir liste des Statuts
		$scope.getListeStatut = function () {
			...
			$http({ method: 'GET', url: $scope.link +'/convention/api/Controllers/TypeStatutController.php?Action=All' }).
