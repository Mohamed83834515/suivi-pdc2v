...
DECAISSEMENT.controller('DashboardController', function ($rootScope, $scope, $http, $cookies, $routeParams, $httpParamSerializer, $q) {
	...
	$scope.getActivite = function () {
		...
		$http({
			...
			url: $scope.link + '/convention/api/activitestatistique.php?responsable=' + $scope.Fonction + '&executant=' + $scope.nom + '' + '&Partenaire=' + partenaire + '&annee=' + convention_active,
	...
	$scope.getTauxIndicateurByuser = function () {
		...
		$http({
			method: 'GET',
			//url: 'https://sise-pdc2v.org/api/activite.php?responsable=' + $scope.nom,
			url: $scope.link + '/convention/api/TauxIndicateurByUser.php?responsable=' + $scope.Fonction + '&executant=' + $scope.nom + '' + '&Partenaire=' + partenaire + '&annee=' + convention_active,
			headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
		}).success(function (data) {
	...
	$scope.getTauxIndicateurByuserVersion = function (version) {
		...
		$http({
			method: 'GET',
			//url: 'https://sise-pdc2v.org/api/activite.php?responsable=' + $scope.nom,
			url: $scope.link + '/convention/api/TauxIndicateurByUser.php?responsable=' + $scope.Fonction + '&executant=' + $scope.nom + '' + '&Partenaire=' + partenaire + '&annee=' + version,
			headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
		}).success(function (data) {
			$scope.ListeTauxIndic = data.taches;
			$scope.tauxByIndicateurUser = $scope.ListeTauxIndic[0].moyenne_taux_realisation;
	...
	$scope.getTauxDecaisserByuser = function () {
		...
		$http({
			method: 'GET',
			//url: 'https://sise-pdc2v.org/api/activite.php?responsable=' + $scope.nom,
			url: $scope.link + '/convention/api/tauxByUser.php?responsable=' + $scope.Fonction + '&executant=' + $scope.nom + '' + '&Partenaire=' + partenaire + '&annee=' + convention_active,
			headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
		}).success(function (data) {
			...
			if (montant_total === 0) {
				...
				taux = (montant_decaisse / montant_total) * 100;
			}
	...
	$scope.getActiviteChange = function (version) {
		...
		$http({
			method: 'GET',
			//url: 'https://sise-pdc2v.org/api/activite.php?responsable=' + $scope.nom,
			url: $scope.link + '/convention/api/activitestatistique.php?responsable=' + $scope.Fonction + '&executant=' + $scope.nom + '&annee=' + vers + '&Partenaire=' + partenaire,
			headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
		}).success(function (data) {
			$scope.ListeStatistique = data.taches;
		});
	...
	$scope.getListeTacheByUser = function () {
		...
		$http({
			...
			url: $scope.link + '/convention/api/tache_user.php',
			headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
		}).
			success(function (data) {
	...
	$scope.getListeApiTache = function () {
		...
		$http({
			method: 'GET',
			url: $scope.link + '/convention/api/Api_tache.php?responsable=' + $scope.nom,
			headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
		}).success(function (data) {
	...
	$scope.get_Tache_Valide1 = function () {
		...
		for (var i = 0; i < $scope.ListeStatistique.length; i++) {
			if ($scope.ListeStatistique[i].statut == 'Achevé') {
				...
				var idActiviteEnCours = $scope.ListeStatistique[i].id_activite_convention;
				...
				var activiteEnCours = $scope.ListeActivite2.find(function (activite) {
					return activite.id_activite_convention == idActiviteEnCours;
				});
	...
	$scope.get_Tache_Valide = function () {
		...
		// Vérifiez si $scope.ListeStatistique est défini et est un tableau
		if (Array.isArray($scope.ListeStatistique)) {
			for (var i = 0; i < $scope.ListeStatistique.length; i++) {
				if ($scope.ListeStatistique[i].statut === 'Achevé') {
					nombreTachesValides++;
				}
	...
	$scope.get_Tache_Attente1 = function () {
		...
		for (var i = 0; i < $scope.ListeStatistique.length; i++) {
			if ($scope.ListeStatistique[i].statut == 'En cours') {
				// Récupérer l'id activité en cours
				var idActiviteEnCours = $scope.ListeStatistique[i].id_activite_convention;
	...
	$scope.ValideDecaissement = function (id_act, oklm, OK) {
		...
		$http.post($scope.link + '/convention/api/valide_decaissement.php', donnee, config)
	...
	$scope.ValideAllSuivis = function (id_act, OK) {
		...
		//$http.post('https://sise-pdc2v.org/api/update_tache.php', donnee, config)
		$http.post($scope.link + '/convention/api/valide_all_suivi.php', donnee, config)
			.then(function (response) {
				// console.log(response);
				if (response.data.status === "success") {
					var message = "";
	...
	$scope.ValideIndicateur = function (id_act, oklm, OK) {
		...
		//$http.post('https://sise-pdc2v.org/api/update_tache.php', donnee, config)
		$http.post($scope.link + '/convention/api/valide_indicateur.php', donnee, config)
			.then(function (response) {
				// console.log(response);
				if (response.data.status === "success") {
					var message = "";
	...
	$scope.ValideTache = function (id_act, alert, OK) {
		...
		//$http.post('https://sise-pdc2v.org/api/update_tache.php', donnee, config)
		$http.post($scope.link + '/convention/api/valide_tache.php', donnee, config)
			.then(function (response) {
				// console.log(response);
				if (response.data.status === "success") {
	...
	$scope.ValideActivite = function (id_act) {
		...
		//$http.post('https://sise-pdc2v.org/api/update_tache.php', donnee, config)
		$http.post($scope.link + '/convention/api/valide_activite.php', donnee, config)
			.then(function (response) {
				// console.log(response);
				if (response.data.status === "success") {
	...
	$scope.AddNotification = function (id_activite, description, message) {
		...
		$http({
			method: 'post',
			url: $scope.link + '/convention/api/add_notification.php',
			data: fd,
	...
	$scope.UpdateMotif = function () {
		...
		$http({
			method: 'post',
			url: $scope.link + '/convention/api/update_tache.php',
			data: fd,
			headers: { 'Content-Type': undefined },
		}).then(function successCallback(response) {
			$scope.response = response.data
	...
	$scope.UpdateIndicateur = function (id_indicateur, Version) {
		...
		$http({
			method: 'post',
			url: $scope.link + '/convention/api/update_indicateur.php',
			data: fd,
			headers: { 'Content-Type': undefined },
		}).then(function successCallback(response) {
			$scope.response = response.data
	...
	$scope.UpdateMotif2 = function (id_ptba) {
		...
		$http({
			method: 'post',
			url: $scope.link + '/convention/api/insert_indicateur.php',
			data: fd,
			headers: { 'Content-Type': undefined },
		}).then(function successCallback(response) {
	...
	$scope.getMyIndicateur = function (code, id_ptba, convention) {
		...
		for (var i = 0; i < $scope.ListeIndicateurConv.length; i++) {
			if ($scope.ListeIndicateurConv[i].code_activite == code && $scope.ListeIndicateurConv[i].convention == convention) {
				$scope.indicateurs.push($scope.ListeIndicateurConv[i]);
			}
		}
	}
	...
	// 		url: $scope.link + '/convention/api/tacheByactivite.php?responsable=' + 8,
	// 		headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
	// 	}).
	// 		success(function (data) {
	...
	$scope.getTauxRealisation = function () {
		...
		$http({
			method: 'GET',
			url: $scope.link + '/convention/api/taux_realisation.php',
			headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
		}).success(function (data) {
	...
	$scope.getTauxRealiser = function (IdStatut) {
		...
		for (var i = 0; i < $scope.taux.length; i++) {
			if ($scope.taux[i].code_activite == IdStatut) {
	...
	$scope.getTache1 = function (IdStatut) {
		...
		if (!isFinite(sommeMontants)) { // Vérifie si la somme est finie
			return 0; // Si la somme est infinie, retourne 0
		}
		...
		swal({
			...
			.then((willDelete) => {
				if (willDelete) {
					...
					$http.delete($scope.link + '/convention/api/supprimer_suivi.php?id_suivi=' + Motif.id_suivi)
						.then(function (response) {
							$scope.InitialiseDashboardG();
		...
		swal({
			...
			.then((willDelete) => {
				if (willDelete) {
					...
					//$http.post('https://sise-pdc2v.org/api/update_tache.php', donnee, config)
					$http.post($scope.link + '/convention/api/ObservationActivite.php', donnee, config)
						.then(function (response) {
							// console.log(response);
							if (response.data.status === "success") {
	...
	$scope.getTache2 = function (IdMotif, observation) {
	...
	$scope.UpdateHistorique = function () {
		...
		$http({
			method: 'post',
			url: $scope.link + '/convention/api/update_suivi_avancement.php',
			data: fd,
			headers: { 'Content-Type': undefined },
		}).then(function successCallback(response) {
			$scope.response = response.data
	...
	$scope.UpdateDecaissement = function (id) {
		...
		$http({
			method: 'post',
			url: $scope.link + '/convention/api/update_modification.php',
			data: fd,
			headers: { 'Content-Type': undefined },
		}).then(function successCallback(response) {
			$scope.response = response.data
	...
	$scope.confirmDelete1 = function (Motif, id_activite_ptba_2) {
		swal({
			...
			.then((willDelete) => {
				if (willDelete) {
					// Appel à l'API PHP pour supprimer l'élément
					$http.delete($scope.link + '/convention/api/supprimer_suivi_decaissement.php?id_suivi=' + Motif.id_suivi)
						.then(function (response) {
							$scope.InitialiseDashboardG();
							$scope.confirmationSwal("Sous activité supprimé avec succès", "success");
	...
	$scope.UpdateMotif1 = function () {
		...
		$http({
			method: 'post',
			url: $scope.link + '/convention/api/decaissement.php',
			data: fd,
			headers: { 'Content-Type': undefined },
		}).then(function successCallback(response) {
			$scope.response = response.data
