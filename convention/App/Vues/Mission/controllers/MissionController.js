DECAISSEMENT.controller('MissionController', function ($rootScope, $scope, $http, $cookies, $location, $routeParams, $httpParamSerializer) {
	...
	$scope.confirmDelete = function(Motif,mission) {
		...
		.then((willDelete) => {
			if (willDelete) {
				...
				$http.delete($scope.link + '/convention/api/supprimer_suivi_mission.php?id_suivi=' + Motif)
	...
	$scope.UpdateSuiviMission = function () {
		...
		var date_suivi = formatDate($scope.Motif.date_suivi);
			...
			$http({
				method: 'post',
				url: $scope.link + '/convention/api/update_suivi_mission.php',
				data: fd,
				headers: { 'Content-Type': undefined},
			}).then(function successCallback(response){
				$scope.response = response.data
	...
	$scope.AddSuiviMission = function () {
		...
		var date_suivi = formatDate($scope.Motif.date_suivi);
			...
			$http({
				method: 'post',
				url: $scope.link + '/convention/api/inser_suivi_mission.php',
				data: fd,
				headers: { 'Content-Type': undefined},
			}).then(function successCallback(response){
				$scope.response = response.data
	...
	$scope.getListeSuiviMission = function () {
		...
		$http({
			method: 'GET',
			url: $scope.link + '/convention/api/Suivi_Mission.php',
			headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
		}).success(function (data) {
	...
	$scope.getListeMission = function () {
		...
		$http({
			method: 'GET',
			url: $scope.link + '/convention/api/Mission.php',
			headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
		}).success(function (data) {
