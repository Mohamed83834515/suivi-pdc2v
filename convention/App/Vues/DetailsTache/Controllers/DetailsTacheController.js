...
DECAISSEMENT.controller('DetailsTacheController', function ($rootScope,$scope, $http, $cookies, $location, $routeParams) {
	...
	$scope.RelanceDecaissement = function () {
		...
		$http({
			method: 'POST',
			url: $scope.link +'/convention/api/Controllers/DecaissementStatutController.php?Action=RelanceWeb&IdDecaissement=' + $scope.Decaissement.IdDecaissement,
...
//Debut fonction valider relance Decaissement
	...
	$scope.InsertDecaissement = function () {
		...
		$http({
			method: 'POST',
			url: $scope.link +'/convention/api/Controllers/DecaissementStatutController.php?Action=AddWeb',
			headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
			data: donnee
		}).success(function (data) {
	...
	$scope.UpdateDecaissement = function () {
		...
		$http({
			method: 'POST',
			url: $scope.link +'/convention/api/Controllers/DecaissementController.php?Action=Update&IdDecaissement=' + $scope.Decaissement.IdDecaissement, 
			headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
			data: donnee
		}).success(function (data) {
	...
	$scope.DeleteDecaissement = function (IdDecaissement) {
		...
		$http({
			method: 'POST',
			url: $scope.link +'/convention/api/Controllers/DecaissementController.php?Action=Geler&IdDecaissement=' + IdDecaissement,
			headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
			data: donnee
		}).success(function (data) {
	...
	$scope.PublierDecaissement = function (IdDecaissement,Montant,NumeroDecaissement,DateRealisation,Commentaire) {
		...
		$http({
			method: 'POST',
			url: $scope.link +'/convention/api/Controllers/StatutController.php?Action=Add',
			headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
			data: donnee
		}).success(function (data) {
			if (data.Etat == "SUCCES") {
	...
	$scope.getUser = function () {
        ...
        $rootScope.ListeUser= [];
        $http({ method: 'GET',
            url: $scope.link +'/convention/api/Controllers/UtilisateurController.php?Action=All',
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
        }).
	...
	$scope.getListeDecaissement = function (IdStatut) {
		...
		$http({ method: 'GET', url: $scope.link +'/convention/api/Controllers/DecaissementController.php?Action=AllByStatut&IdStatut=' + IdStatut +"&Idusrcreation="+ Idusrcreation }).
			success(function (data, status, headers, config) {
	...
	$scope.getListeMotif = function () {
		...
		$http({ method: 'GET', url: $scope.link +'/convention/api/Controllers/MotifController.php?Action=All' }).
			success(function (data, status, headers, config) {
	...
	$scope.getListeStatut = function () {
		...
		$http({ method: 'GET', url: $scope.link +'/convention/api/Controllers/StatutController.php?Action=All' }).
			success(function (data, status, headers, config) {
	...
	$scope.getOneDecaissement = function (IdDecaissement) {
		...
		$http({ method: 'GET', url: $scope.link +'/convention/api/Controllers/DecaissementController.php?Action=One&IdDecaissement=' + IdDecaissement }).
			success(function (data, status, headers, config) {
