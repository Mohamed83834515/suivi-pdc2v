...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['lot'])) {
        ...
        $updateQuery = "UPDATE suivi_avancement_contrat_convention SET
            date_suivi = ?,
            code_suivi = ?,
            observation = ?,
            retard_accuse = ?,
        ...
        $stmt->bind_param("sssssssssi", $newDateFin, $lot, $newObservation, $retard, $filename, $statut_tache, $difficultes, $pistes_solutions, $id_personnel,$taskId);
