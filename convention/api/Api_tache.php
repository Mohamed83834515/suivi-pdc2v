...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if (isset($_GET['responsable'])) {
        ...
        $query = "SELECT * FROM ptba INNER JOIN suivi_avancement_contrat_convention ON ptba.id_ptba = suivi_avancement_contrat_convention.id_activite_ptba WHERE ptba.executant ='$userId'";
