...
DECAISSEMENT.controller('EtatController', function ($rootScope, $scope, $http, $cookies, $location, $routeParams, blockUI) {
	...
	$scope.TelechargerTableauEnExcel = function () {
		...
		var titleHtml = "<h4 style='text-align: center;'>Rapports d'état d'avancement des activités au " + formattedDate + "</h4>";
	...
	$scope.TelechargerEnPDF1 = function () {
		...
		titleHtml += "<h4 style='text-align: center; font-familly: cursive;'>Rapport d'état d'avancement des activités</h4>";
