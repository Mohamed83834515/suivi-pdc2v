DECAISSEMENT.controller('MasterController', function ($scope, Idle, Keepalive, $rootScope, $routeParams, $location, $http, $cookies, $httpParamSerializer) {
    ...
    $scope.LoadConvention = function () {
        window.location.href = $rootScope.link + "/convention/App/Vues/master.html";
    };
    ...
    $scope.getNotifications = function () {
        ...
        $http({
            ...
            url: $scope.link + '/api/liste_notification.php?responsable=' + fonction,
    ...
    $scope.getConnectedUser = function () {
        ...
        $http({
            method: 'GET',
            url: $scope.link + '/Api/Controllers/UtilisateurController.php?Action=One&IdUtilisateur=' + userId,
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
        }).
    ...
    $scope.ValideNotification = function (id_act, id_activite) {
		...
		$http.post($scope.link + '/api/valide_notification.php', donnee, config)
    ...
    //     $http({ method: 'GET',
    //         url: $scope.link +'/Api/Controllers/ProfilModuleDroitController.php?Action=AllByProfil&IdProfil='+userIdProfil,
    //         headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
    //     }).
    //         success(function (data, status, headers, config) {
