...
DECAISSEMENT.controller('TypeBeneficiaireController', function ($rootScope,$scope, $http, $cookies) {
	...
	$scope.InsertTypeBeneficiaire = function () {
		...
		$http({
			method: 'POST',
			url: $scope.link +'/Api/Controllers/TypeBeneficiaireController.php?Action=Add',
	...
	$scope.UpdateTypeBeneficiaire = function () {
		...
		$http({
			method: 'POST',
			url: $scope.link +'/Api/Controllers/TypeBeneficiaireController.php?Action=Update&IdTypeBeneficiaire=' + $scope.TypeBeneficiaire.IdTypeBeneficiaire,
			headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
			data: donnee
		}).success(function (data) {
	...
	$scope.DeleteTypeBeneficiaire = function (IdTypeBeneficiaire) {
		...
		$http({
			method: 'POST',
			url: $scope.link +'/Api/Controllers/TypeBeneficiaireController.php?Action=Delete&IdTypeBeneficiaire=' + IdTypeBeneficiaire,
			headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
			data: donnee
		}).success(function (data) {
	...
	$scope.getListeTypeBeneficiaire = function () {
		...
		$http({ method: 'GET', url: $scope.link +'/Api/Controllers/TypeBeneficiaireController.php?Action=All' }).
