	...
	DECAISSEMENT.controller('BeneficiaireController', function($rootScope,$scope,$http,$cookies){
        ...
        $scope.InsertBeneficiaire = function () {
            ...
            $http({
                method: 'POST',
                url: $scope.link +'/Api/Controllers/BeneficiaireController.php?Action=Add',
        ...
        $scope.UpdateBeneficiaire = function () {
            ...
            $http({
                method: 'POST',
                url: $scope.link +'/Api/Controllers/BeneficiaireController.php?Action=Update&IdBeneficiaire=' + $scope.Beneficiaire.IdBeneficiaire,
                headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
                data: donnee
            }).success(function (data) {
        ...
        $scope.DeleteBeneficiaire = function (IdBeneficiaire) {
            ...
            $http({
                method: 'POST',
                url: $scope.link +'/Api/Controllers/BeneficiaireController.php?Action=Delete&IdBeneficiaire=' + IdBeneficiaire,
                headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
                data: donnee
            }).success(function (data) {
