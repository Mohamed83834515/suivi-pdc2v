DECAISSEMENT.controller('LoginController', function ($scope, $http, $cookies) {
    ...
    $scope.Login = function () {
        ...
        $http({
            method: 'POST',
            url: $scope.link + '/api/connexion.php',
    ...
    $scope.ChangerMotDePasse = function () {
        ...
        $http({
            method: 'POST',
            url: $scope.link + '/Api/Controllers/UtilisateurController.php?Action=UpdatePassword&IdUtilisateur=' + $scope.IdUtilisateur,
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
            data: donnee
    ...
    $scope.ForgotPassword = function () {
        ...
        $http({
            method: 'POST',
            url: $scope.link + '/Api/Controllers/UtilisateurController.php?Action=ResetPassword&IdUtilisateur=' + $scope.IdUtilisateur,
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
            data: donnee
        }).success(function (data) {
    ...
    $scope.getListeUtilisateur = function () {
        ...
        $http({ method: 'GET', url: $scope.link + '/Api/Controllers/UtilisateurController.php?Action=All' }).
